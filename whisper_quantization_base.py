...
# Same file as whisper_quantization but using openai/whisper-base
import torch
import torchaudio
...
save_dir = "Models/quantized_whisper_base"
os.makedirs(save_dir, exist_ok=True)

# Save the entire quantized model using torch.save()
torch.save(quantized_model, os.path.join(save_dir, "quantized_model_base.pth"))
